...
public class DataSourceProperties
    ...
    public String determineDriverClassName() {
        ...
        if (StringUtils.hasText(this.url)) {
            driver = DatabaseDriver.fromJdbcUrl(this.url).getDriverClassName();
        }

        if (!StringUtils.hasText(driverClassName)) {
            driver = this.embeddedDatabaseConnection.getDriverClassName();
        }
    ...
    public String determineUrl() {
        ...
        String urlName = this.embeddedDatabaseConnection.getUrl(this.name);
